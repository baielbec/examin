...
const Footer = () => {
    return (
        <div className="bg-[#010049] flex flex-col">
            <div className="container sm:basis-1/2  md:basis-1/2 flex justify-around  lg:basis-1/3 flex justify-around  xl:basis-1/4  flex justify-around text-center font-robo">
